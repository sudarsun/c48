...
void NBTreeClassifierTree::dumpTreeNB(int depth, std::string text) {
...
std::string NBTreeClassifierTree::graph()  {

	std::string text = "";

	text.append("digraph J48Tree {\n");
	if (misLeaf) {
		text.append(std::string("N") + std::to_string(mid) + std::string(" [label=\"") + std::string("NB mode") + std::string("\" ") + std::string("shape=box style=filled "));
...
void NBTreeClassifierTree::graphTree(std::string text) {
